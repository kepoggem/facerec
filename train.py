...
def get_symbol(batchsize=32):
	...
	center_loss_ = mx.symbol.Custom(data=embedding, label=center_label, name='center_loss_', op_type='centerloss', num_class=config.NUM_CLASSES, alpha=0.1, scale=1.0, batchsize=batchsize)
