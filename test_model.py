...
def test(args, network, data_loader, data_shape, batch_end_callback=None, patterns=None, initializers=None):
    # kvstore
    ...
    argParams = None
    auxParams = None
    opt = mx.optimizer.SGD(learning_rate=1e-6, momentum=0.9, wd=0.0001, rescale_grad=1.0 / 64)
