...
def fit(args, network, data_loader, data_shape, batch_end_callback=None, patterns=None, initializers=None):
    ...
    argParams = None
    auxParams = None
    #opt = mx.optimizer.SGD(learning_rate=1e-5, momentum=0.9, wd=0.0001, rescale_grad=1.0 / 64)
    opt = mx.optimizer.RMSProp(learning_rate=1e-5, gamma1=0.95, gamma2=0.95, rescale_grad=1.0 / 64)
