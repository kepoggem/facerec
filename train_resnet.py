...
from neuralnetwork.nn.mxconv import MxResNet
...
opt = mx.optimizer.SGD(learning_rate=1e-3, momentum=0.9, wd=0.0001,
...
if args["start_epoch"] <= 0:
	...
	model = MxResNet.build(config.NUM_CLASSES, (3, 4, 6, 3),
